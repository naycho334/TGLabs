...
const PREFIX = `admin/support/all_support_tickets`;
...
const { reducer: adminAllSupportTicketsReducer, actions } = slice;

export const adminAllSupportTicketsActions = {
  ...actions,
  updateTicket,
  fetchData,
}

export default adminAllSupportTicketsReducer;