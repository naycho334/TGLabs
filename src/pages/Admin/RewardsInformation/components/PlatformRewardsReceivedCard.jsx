...
const PlatformRewardsReceivedCard = (props) => {
      ...
      <Grid container className={clsx("extendCard", isOpen && "open")}>
        <Grid item xs={12}>
          <Grid container alignItems="center" justify="space-between">
            {get([0, 3]).map(({ Component, props }, index) => (
              <Grid item key={index}>
...
PlatformRewardsReceivedCard.propTypes = {
...
export default memo(PlatformRewardsReceivedCard);
